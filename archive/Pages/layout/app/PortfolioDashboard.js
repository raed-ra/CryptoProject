...
const Dash = props => {
    ...
    const totalHolding = async (holdingList) => {
        ...
        console.log(totalValueOfHoldings)
        console.log(listOfProfitArray)
        console.log(percentageOfChangeForEveryCoin)
        setTotalValueOfHoldings(totalValueOfHoldings.toFixed(0))
        ...
        setAcquisitionCost(totalAcquistionCost.toFixed(0))

        //-------------------------------
        setProfitLoss(totalValueOfHoldings-totalAcquistionCost)

        //--------------------------------
        setPortfolioChange(((totalValueOfHoldings-totalAcquistionCost)*100/totalAcquistionCost).toFixed(0))
        ...
        <Container className='mt-5' >
            <Card >
                ...
                <Card className='mt-3' >
                    ...
                    <Card>{tableType === "holding" ? <HoldingTable chartSelectCoin={chartSelectCoin} /> : <TransactionTable chartSelectCoin={chartSelectCoin} />}</Card>
